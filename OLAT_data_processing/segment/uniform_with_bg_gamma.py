...
def infer_out_dir(
    ...
    Args:
        ...
        root_in: 输入根目录 (通常是第一步 ROOT_OUT)
        root_out: 输出根目录 (例如 for_segmentation_5)
...
class OLATDelight:
    def __init__(self, olat_txt, olat_img_dir, root_in, root_out,
        ...
        self.out_dir = infer_out_dir(self.olat_img_dir, root_in=root_in, root_out=root_out)
